...
if __name__ == "__main__":
    ...
    players=['Player_noheuristic_00', 'Player_heuristic_81', 'Player_heuristic_21'] # heuristic_# means that the three piece score is #
    game_score={}
    for i in range(3):
    ...
    print(game_score)
    np.save('game_score_heuristics.npy', game_score)
